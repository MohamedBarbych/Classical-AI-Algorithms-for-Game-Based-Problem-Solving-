package ADV;
//La strategie des jeux et des methodes a redefinir pour chaque jeux
import java.util.*;
//Min et max tres exaustif coté de recherche
...
//Il choisit la bonne positon en utillisant alphaBeta
    ...
    public void playGame(Position startingPosition, boolean humanPlayFirst) {
        ...
        while (true) {
            ...
            printPosition(startingPosition);
             ...
             //Donne la main a la machine pour son role
            Vector v = alphaBeta(0, startingPosition, PROGRAM);
