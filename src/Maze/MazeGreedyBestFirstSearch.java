...
/**
 * Title:        MazeGreedyBestFirstSearch<p>
 * Description:  Demo program for Greedy Best-First Search in a maze<p>
...
public class MazeGreedyBestFirstSearch extends JFrame {
    JPanel jPanel1 = new JPanel();
    GreedyBestFirstSearchEngine currentSearchEngine = null;

    public MazeGreedyBestFirstSearch(int height, int width) {
        try {
            jbInit();
        } catch (Exception e) {
            System.out.println("GUI initialization error: " + e);
        }
        currentSearchEngine = new GreedyBestFirstSearchEngine(height, width);
        currentSearchEngine.search(); // Start the search
        repaint();
    }
    ...
    public static void main(String[] args) {
        MazeGreedyBestFirstSearch mazeSearch1 = new MazeGreedyBestFirstSearch(10, 10);
    }
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("MazeGreedyBestFirstSearch");
