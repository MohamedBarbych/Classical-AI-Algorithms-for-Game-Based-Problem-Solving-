...
//        tempMoves[0] = new Dimension(loc.width - 1, loc.height);     // Left
//        tempMoves[1] = new Dimension(loc.width + 1, loc.height);     // Right
//        tempMoves[2] = new Dimension(loc.width, loc.height - 1);     // Up
//        tempMoves[3] = new Dimension(loc.width, loc.height + 1);     // Down
//        tempMoves[4] = new Dimension(loc.width - 1, loc.height - 1); // Up-Left
//        tempMoves[5] = new Dimension(loc.width + 1, loc.height - 1); // Up-Right
//        tempMoves[6] = new Dimension(loc.width - 1, loc.height + 1); // Down-Left
//        tempMoves[7] = new Dimension(loc.width + 1, loc.height + 1); // Down-Right
//
//        return tempMoves;
//    }
